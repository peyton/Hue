...
class NSColorTests: XCTestCase {
  ...
  func testHex() {
    ...
    XCTAssertEqual(white, NSColor(red: 1, green: 1, blue: 1, alpha: 1))
    XCTAssertEqual(black, NSColor(red: 0, green: 0, blue: 0, alpha: 1))
    XCTAssertEqual(red, NSColor(red: 1, green: 0, blue: 0, alpha: 1))
    XCTAssertEqual(blue, NSColor(red: 0, green: 0, blue: 1, alpha: 1))
    XCTAssertEqual(green, NSColor(red: 0, green: 1, blue: 0, alpha: 1))
    XCTAssertEqual(yellow, NSColor(red: 1, green: 1, blue: 0, alpha: 1))
  }
  ...
  func testAlpha() {
    ...
    XCTAssertEqual(yellowWithAlpha, NSColor(red: 1, green: 1, blue: 0, alpha: 1).withAlphaComponent(0.5))
  }
